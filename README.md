# One-dimensional Commutative-Quasigroup-Actions
...
# Check also ideas and code for a PoC for a 2D commutative quasigroup-action key exchange in a 2-adic regime
